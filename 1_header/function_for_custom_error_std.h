...
//         print_vector_in_vector(solution_2ndds_second_refine_at_quads_per_cell, 2);
...
//         print_vector_in_vector(solution_2ndds_first_refine_at_quads_per_cell, 2);
...
//   cout << "  vector_error:\n";
//   print_vector_horizontally(vector_error);  
